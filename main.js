...
`;function Ta(r,e,t=!1){if(r==null||e==null||r<=0||!t&&e<=0)return"";let n=r+e,i=n%3===2?10:n%3===1?8:6;return`${Math.trunc(n/3)}d6+d${i}`}function Oe(r){let e=Number.parseInt(r,10);return isNaN(e)?0:e??0}function Be(r){return r===void 0||isNaN(r)?"":Math.round(r).toString()}var Aa={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Sa=r=>(...e)=>({_$litDirective$:r,values:e}),kn=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};var qg=Sa(class extends kn{constructor(r){if(super(r),r.type!==Aa.ATTRIBUTE||r.name!=="class"||r.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(e=>r[e]).join(" ")+" "}update(r,[e]){if(this.st===void 0){this.st=new Set,r.strings!==void 0&&(this.nt=new Set(r.strings.join(" ").split(/\s/).filter(n=>n!=="")));for(let n in e)e[n]&&!this.nt?.has(n)&&this.st.add(n);return this.render(e)}let t=r.element.classList;for(let n of this.st)n in e||(t.remove(n),this.st.delete(n));for(let n in e){let i=!!e[n];i===this.st.has(n)||this.nt?.has(n)||(i?(t.add(n),this.st.add(n)):(t.remove(n),this.st.delete(n)))}return Je}});var zt=class extends U{constructor(){super(...arguments);this.size=24;this.strokeWidth=2}render(){this.style.setProperty("--icon-width",`${this.size}px`),this.style.setProperty("--icon-height",`${this.size}px`);let t=Zi(this.icon);return t.setAttribute("stroke-width",this.strokeWidth.toString()),R`${t}`}};zt.styles=[B`
    ...
    `],S([D({type:Object})],Ht.prototype,"model",2),S([D({type:Number})],Ht.prototype,"columnCount",2),S([D({type:Boolean})],Ht.prototype,"locked",2),Ht=S([j("attributes-view")],Ht);var Rn=class extends U{render(){return R`
      <h2>Description</h2>
      <section>
        <textarea
    ...
    `}onDescriptionChanged(e){this.dispatchEvent(new CustomEvent("character-change",{detail:{change:{description:e.target.value}},bubbles:!0,composed:!0}))}};Rn.styles=[z,B`
      :host {
        display: block;
        padding: 4px 8px;
        border-radius: 2px;
    ...
    `],S([D({type:Object})],Rn.prototype,"model",2),Rn=S([j("character-description-view")],Rn);var Pn=class extends U{render(){return R`
    ...
    `}fieldChangeHandler(e){return t=>{this.dispatchEvent(new CustomEvent("character-change",{detail:{change:{[e]:t.target.value}},bubbles:!0,composed:!0}))}}};Pn.styles=[z,B`
      :host {
        position: relative;
        display: block;
        padding: 4px 8px;
    ...
    `],S([D({type:Object})],Pn.prototype,"model",2),Pn=S([j("character-info-view")],Pn);var Dn=class extends U{render(){return R`
      <input
        type="text"
        class="name"
        .value=${this.model.name}
    ...
    `],S([D({type:Object})],Dn.prototype,"model",2),Dn=S([j("connection-view")],Dn);var Pr=class extends U{constructor(){super(...arguments);this.locked=!0}render(){return R`
    ...
    `],S([D({type:Object})],Gt.prototype,"model",2),S([D({type:Boolean})],Gt.prototype,"showHeader",2),S([D({type:Boolean})],Gt.prototype,"locked",2),Gt=S([j("equipment-view")],Gt);var Nn=class extends U{render(){return R`
      ...
      />
    `}onXPChanged(e){let t=Oe(e.target.value);isNaN(t)&&(t=0),this.dispatchEvent(new CustomEvent("character-change",{detail:{change:{xp:t}},bubbles:!0,composed:!0}))}};Nn.styles=[z,B`
      :host {
        display: flex;
        padding: 4px;
        margin: 8px;
    ...
    `],S([D({type:Object})],Nn.prototype,"model",2),Nn=S([j("general-xp-view")],Nn);var On=class extends U{constructor(){super(...arguments);this.on=!1}connectedCallback(){super.connectedCallback(),this.role="button"}render(){return R`
      ${jt(this.on,()=>R`<slot name="on" @slotchange=${this.preventFocus}></slot>`,()=>R`<slot @slotchange=${this.preventFocus}></slot>`)}
    `}preventFocus(t){let n=t.target;for(let i of n.assignedElements())i.setAttribute("tabindex","-1")}};On.styles=[z,B`
      :host {
        cursor: pointer;
        display: inline-block;
        border-radius: 50%;
    ...
    `],S([D({type:Boolean})],On.prototype,"on",2),On=S([j("icon-button")],On);var Wt=class extends U{constructor(){super(...arguments);this.showHeader=!1;this.locked=!0}render(){return R`
      ${this.showHeader?this.renderHeader():R``}
      <div id="content">
        <input
          type="text"
    ...
    `],S([D({type:Object})],Wt.prototype,"model",2),S([D({type:Boolean})],Wt.prototype,"showHeader",2),S([D({type:Boolean})],Wt.prototype,"locked",2),Wt=S([j("item-view")],Wt);var Dr=class extends U{constructor(){super(...arguments);this.locked=!0}render(){return R`
    ...
    `}onAddEquipmentButtonClicked(t){this.dispatchEvent(new CustomEvent("add-equipment-row",{detail:{},bubbles:!0,composed:!0,cancelable:!1}))}onAddItemButtonClicked(t){this.dispatchEvent(new CustomEvent("add-item-row",{detail:{},bubbles:!0,composed:!0,cancelable:!1}))}};Dr.styles=[z,B`
      :host {
        display: block;
        padding: 4px 8px;
        border-radius: 2px;
    ...
    `],S([D({type:Object})],Dr.prototype,"model",2),S([D({type:Boolean})],Dr.prototype,"locked",2),Dr=S([j("inventory-view")],Dr);var Mn=class extends U{render(){return R`
      <h2>Notes</h2>
      <section>
        <textarea
    ...
    `],S([D({type:Object})],Nr.prototype,"model",2),S([$e("dialog")],Nr.prototype,"_dialog",2),Nr=S([j("npc-generator")],Nr);var Or=class extends U{render(){return R`<dialog>
    ...
    </dialog>`}show(){this._dialog.showModal()}};Or.styles=[z,B`
      h2 {
        margin: 0 0 16px;
      }
      div {
    ...
    `],S([D({type:String})],Or.prototype,"uid",2),S([$e("dialog")],Or.prototype,"_dialog",2),Or=S([j("cloud-access-error-dialog")],Or);He({icons:[Cn]});var Ln=class extends U{constructor(){super(...arguments);this.size=32}render(){return R`<lucide-icon
      .size=${this.size}
      .icon=${Cn}
    ...
    `],S([D({type:Object})],Kt.prototype,"model",2),S([$e("#file-picker")],Kt.prototype,"filePicker",2),S([Sn()],Kt.prototype,"loading",2),Kt=S([j("portrait-view")],Kt);He({icons:{Plus:ut}});var Qt=class extends U{constructor(){super(...arguments);this.generalXp=0;this.locked=!0}render(){return R`
      <button
        id="buy-button"
        class="buy-button"
        ?disabled=${!this.canAffordRank||!this.model.name}
    ...
    `],S([D({type:Object})],Xt.prototype,"model",2),S([D({type:Number})],Xt.prototype,"columnCount",2),S([D({type:Boolean})],Xt.prototype,"locked",2),Xt=S([j("specializations-view")],Xt);var Mr=class extends U{constructor(){super(...arguments);this.showHeader=!1}render(){return R`
      ${this.showHeader?this.renderHeader():R``}
      <div id="content">
        <input
          type="checkbox"
    ...
    `}onCheckedChanged(t){this.dispatchEvent(new CustomEvent("wound-level-change",{detail:{id:this.model.id,checked:t.target.checked},bubbles:!0,composed:!0}))}};Mr.styles=[z,B`
      :host {
        display: block;
      }
    ...
    `],S([D({type:Object})],Mr.prototype,"model",2),S([D({type:Boolean})],Mr.prototype,"showHeader",2),Mr=S([j("wound-level-view")],Mr);var Lr=class extends U{constructor(){super(...arguments);this.showHeader=!1}render(){return R`
      ${this.showHeader?this.renderHeader():R``}
      <div id="content">
        <input
          type="checkbox"
    ...
    `}onCheckedChanged(t){this.dispatchEvent(new CustomEvent("fatigue-level-change",{detail:{id:this.model.id,checked:t.target.checked},bubbles:!0,composed:!0}))}};Lr.styles=[z,B`
      :host {
        display: block;
      }
    ...
    `],S([D({type:Object})],Lr.prototype,"model",2),S([D({type:Boolean})],Lr.prototype,"showHeader",2),Lr=S([j("fatigue-level-view")],Lr);var Vr=class extends U{constructor(){super(...arguments);this.locked=!0}render(){return R`
      <h2>Status</h2>
      <section>
        <div id="wound-levels">
    ...
    `],S([D({type:Object})],Vr.prototype,"model",2),S([D({type:Boolean})],Vr.prototype,"locked",2),Vr=S([j("status-view")],Vr);var Vn=class extends U{render(){return R`
      <h2>Wealth</h2>
    ...
    `],S([D({type:Array})],Jt.prototype,"sheets",2),S([Sn()],Jt.prototype,"selectedSheet",2),S([$e("dialog")],Jt.prototype,"_dialog",2),Jt=S([j("cloud-choose-sheet-dialog")],Jt);var Fr=class extends U{constructor(){super(...arguments);this.duration=5}connectedCallback(){super.connectedCallback()}show(){this.toast.style.animationName="slide-in",this.toast.style.animationDirection="running",setTimeout(()=>{this.toast.style.animationName="slide-out",this.toast.style.animationPlayState="running"},this.duration*1e3)}render(){return R`
      <div id="toast">
        <slot></slot>
      </div>
    `}};Fr.styles=[z,B`
    ...
    `],S([D({type:Object})],V.prototype,"model",2),S([D({type:Number})],V.prototype,"columnCount",2),S([D({type:Boolean})],V.prototype,"locked",2),S([D({type:Object})],V.prototype,"user",2),S([Sn()],V.prototype,"availableSheets",2),S([$e("#modal-loading-spinner")],V.prototype,"modalLoadingSpinner",2),S([$e("#save-complete-toast")],V.prototype,"saveCompleteToast",2),V=S([j("character-sheet")],V);})();
